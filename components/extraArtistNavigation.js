    ...
    <div className="flex flex-row xxs:h-[120px] lg:h-[150px] xl:h-[180px] w-full max-w-screen-xl">
      ...
      <div className="flex flex-col h-full flex-1 xxs:bg-black md:bg-white">
        <div className="xxs:ml-[10px] lg:ml-[80px] md:mt-[20px]">
          <div className="font-poppins font-bold md:text-2xl lg:text-3xl xl:text-4xl xxs:text-white md:text-black">
            {artist ? (
              artist
            ) : (
          ...
          <div className="font-poppins font-extralight md:text-sm lg:text-base xl:text-lg text-slate-400">
            {length ? (
