export const StickyArtistNavigation = () => {
  return (
    <div className="flex flex-row xxs:h-[60px] md:h-[40px] w-full max-w-screen-xl">
      ...
      <div className="flex items-end h-full flex-1 xxs:bg-black md:bg-white">
        <div className="flex flex-row justify-end w-full h-[50px] border-b-2 border-neutral-300">
          ...
          <div className="justify-center items-center h-full xxs:w-1/3 md:w-1/6 font-poppins font-black xxs:text-sm lg:text-base xl:text-xl 2xl:text-2xl xxs:text-white md:text-#8289a1 text-center md:pb-2 lg:pb-6 xxs:hidden md:flex">
            PEAK POS.
          </div>
          <div className="justify-center items-center h-full xxs:w-1/3 md:w-1/6 font-poppins font-black xxs:text-sm lg:text-base xl:text-xl 2xl:text-2xl xxs:text-white md:text-#8289a1 text-center md:pb-2 lg:pb-6 xxs:hidden md:flex">
            PEAK DATE
          ...
          <div className="flex justify-center items-center h-full xxs:w-1/3 md:w-1/6 font-poppins xxs:font-bold md:font-black xxs:text-sm md:text-sm lg:text-base xl:text-xl 2xl:text-2xl xxs:text-white md:text-#8289a1 text-center md:pb-2 lg:pb-6 xxs:hidden md:flex">
            WKS ON CHART
          </div>
          <div className="justify-center items-center h-full xxs:w-1/3 md:w-1/6 font-poppins font-black xxs:text-sm lg:text-base xl:text-xl 2xl:text-2xl xxs:text-white md:text-#8289a1 text-center pb-6 xxs:flex md:hidden whitespace-pre-wrap">
            {`WKS ON\nCHART`}
